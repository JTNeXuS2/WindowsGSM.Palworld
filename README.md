...
6. Extract [Palworld-Server-Modding.zip](https://github.com/JTNeXuS2/WindowsGSM.Palworld/releases/download/1.0.0/Palworld-Server-Modding.zip) to serverfiles\\**Pal\Binaries\Win64** folder
### addition modding
